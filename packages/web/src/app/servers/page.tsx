...
export const metadata: Metadata = {
  title: "Servers — Browse MCP Server Directory",
  description:
    "Browse, search, and filter thousands of MCP servers. View health status, trust scores, latency, and uptime for every server.",
};
...
export default async function ServersPage({ searchParams }: { searchParams: Promise<Record<string, string>> }) {
  ...
  return (
    <div className="space-y-8">
      <div className="space-y-2">
        <h1 className="text-3xl font-bold tracking-tight">MCP Server Directory</h1>
        <p className="text-gray-400">Browse, search, and filter {stats ? `${stats.totalServers.toLocaleString()}+` : ""} MCP servers from the official registry and Smithery.ai.</p>
      </div>
